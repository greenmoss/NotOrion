...
min_width = random.randint(2,20)
amount = random.randint(2,20)
print 'min_width: %d; amount: %d'%(min_width, amount)
...
sub_rect_amounts = utilities.randomly_split_rectangle(bottom,left,top,right,min_width,amount)
...
batch2.add(4, GL_QUADS, layer4,
	( 'v2i', (left,bottom, left,bottom+min_width-1, left+min_width-1,bottom+min_width-1, left+min_width-1,bottom)),
)
